...
mod tests {
    ...
    const TLS_NO_SNI: &[u8] = &[
        0x16, 0x03, 0x01, 0x00, 0x2d, // TLS Record: Handshake, TLS 1.0, Length 45
        0x01, 0x00, 0x00, 0x29, // Handshake: ClientHello, Length 41
        0x03, 0x03, // Version: TLS 1.2
        // Random (32 bytes)
        0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e,
        0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d,
        0x1e, 0x1f, 0x00, // Session ID length: 0
        0x00, 0x02, // Cipher suites length: 2
        0x00, 0x3c, // One cipher suite (TLS_RSA_WITH_AES_256_CBC_SHA256)
        0x01, // Compression methods length: 1
        0x00, // Compression method: null
              // No extensions follow
    ];
